package com.mit.core.shiro.token.manager;
...
import com.mit.common.utils.SpringContextUtil;
import com.mit.core.shiro.session.CustomSessionManager;
import com.mit.core.shiro.token.SampleRealm;
import com.mit.core.shiro.token.ShiroToken;
...
public class TokenManager {
	...
	public static Long getCenterId(){
		return getToken()==null?null:getToken().getCenterid();
	}
}
