package com.mit.core.shiro.service.impl;
...
import com.mit.core.config.INI4j;
import com.mit.core.shiro.service.ShiroManager;
/**
 * 
 * 
 * 动态加载权限 Service
...
public class ShiroManagerImpl implements ShiroManager {
	...
	private String getFixedAuthRule(){
		...
		ClassPathResource cp = new ClassPathResource("com/mit/resources/" + fileName);//ini文件修改时，请记得更改路径 -liupengfei
		INI4j ini = null;
		try {
