package com.mit.core.shiro.cache;
...
import com.mit.common.utils.SerializeUtil;
import com.mit.core.shiro.session.CustomSessionManager;
import com.mit.core.shiro.session.SessionStatus;
import com.mit.core.shiro.session.ShiroSessionRepository;
/**
 * Session 管理
 * @author sojson.com
 *
...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
    public static final String REDIS_SHIRO_SESSION = "ams-session:";
    //这里有个小BUG，因为Redis使用序列化后，Key反序列化回来发现前面有一段乱码，解决的办法是存储缓存不序列化
    public static final String REDIS_SHIRO_ALL = "*ams-session:*";
