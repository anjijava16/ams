...
* @Description: 生成实体类
* @author 刘鹏飞
* @date 2016-9-27 上午10:17:58  
*
 */
public class GenEntityOracle {
	
	private String packageOutPath = "com.mit.customer.bo";//指定实体生成所在包的路径
	private String authorName = "刘鹏飞";//作者名字
	private String tablename = "T_CAR_INFO";//表名
    ...
    //数据库连接
	 private static final String URL ="jdbc:oracle:thin:@192.168.202.14:1522:zg2scg";
	 private static final String NAME = "ams";
	 private static final String PASS = "ams";
