package com.mit.common.controller;
...
import com.mit.common.utils.vcode.Captcha;
import com.mit.common.utils.vcode.GifCaptcha;
import com.mit.common.utils.vcode.SpecCaptcha;
...
public class CommonController extends BaseController {
	...
	public ModelAndView _404(HttpServletRequest request){
		ModelAndView view = new ModelAndView("views/404");
		return view;
	}
	/**
	 * 500错误
	...
	public ModelAndView _500(HttpServletRequest request){
		ModelAndView view = new ModelAndView("views/500");
	...
	public ModelAndView unauthorized(){
		return new ModelAndView("views/unauthorized");
	}
