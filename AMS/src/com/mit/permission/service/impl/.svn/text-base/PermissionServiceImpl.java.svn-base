...
import com.mit.common.dao.PermissionMapper;
import com.mit.common.dao.RolePermissionMapper;
import com.mit.common.dao.UserMapper;
import com.mit.common.dao.UserRoleMapper;
import com.mit.common.model.Permission;
import com.mit.common.model.RolePermission;
...
public class PermissionServiceImpl extends BaseMybatisDao<PermissionMapper> implements PermissionService {
	...
	@Override
	public List<PermissionBo> selectPermissionById(Map<String, Object> resultMap) {
		return permissionMapper.selectPermissionById(resultMap);
	}
