...
<html lang="zh-cn">
	<head>
		<meta charset="utf-8" />
		<title>钣喷中心信息管理 —工位管理-工位添加</title>
   ...
   <li class="active">
         ...
         <li>
			...
			<div class="col-md-10">
					<h2>工位添加</h2>
					<hr>
				<form id="formId" enctype="multipart/form-data" action="<%=basePath%>/station/addWorkplace" method="post" class="form-horizontal">
      ...
      <option value="">请选择...</option>             
         ...
         <option value="${it.id}">${it.place_parent_name}-${it.place_name}</option>
                             </c:forEach>                                       </select></div>
</div>
    <div class="form-group">
						    <label for="w_name" class="col-sm-2 control-label">工位名称</label>
						 <div class="col-sm-5"> <input type="text" class="form-control" name="w_name" id="w_name" placeholder="工位名称"/></div>
						  </div><div class="form-group">
						    <label for="w_no" class="col-sm-2 control-label">工位号</label>
						 <div class="col-sm-5"> <input type="text" class="form-control" name="w_no" id="w_no" placeholder="请输入工位号"/></div>
						  </div><div class="form-group">
						    <label for="equipment_id" class="col-sm-2 control-label">车辆检测器序号</label>
						 <div class="col-sm-5"> <input type="text" class="form-control" name="equipment_id" id="equipment_id" placeholder="车辆检测器序号"/></div>
						  </div>                       
