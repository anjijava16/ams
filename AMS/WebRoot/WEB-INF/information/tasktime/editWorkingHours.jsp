...
<html lang="zh-cn">
	<head>
		<meta charset="utf-8" />
		<title>钣喷中心信息管理 —标准工时管理-编辑标准工时信息</title>
   ...
   <li class="active">
			...
			<div class="col-md-10">
					<h2>标准工时信息编辑</h2>
					<hr>
				<form id="formId" enctype="multipart/form-data" action="<%=basePath%>/tasktime/updateWorkingHours" method="post" class="form-horizontal">
                <input type="hidden" name="id" value="${workingHours.id}">
                <input type="hidden" name="centerid" value="${workingHours.centerid}">
