...
<html lang="zh-cn">
	<head>
		<meta charset="utf-8" />
		<title>系统管理 —数据字典-编辑基础配件信息</title>
	...
	<ul data-spy="affix" class="nav nav-list nav-tabs nav-stacked bs-docs-sidenav dropdown affix submenu" style=" left:0;top: 151px; z-index: 100;">
        ...
        <li class="active">	    
         ...
         <li>	    
			...
			<div class="col-md-10">
					<h2>基础配件信息编辑</h2>
					<hr>
				<form id="formId" enctype="multipart/form-data" action="<%=basePath%>/carParts/updateCarParts" method="post" class="form-horizontal">
                 <input type="hidden" name="id" value="${carParts.id}">
						  <div class="form-group">
						   ...
						   <input type="text" class="form-control"  name="damage_parts_group" id="damage_parts_group" placeholder="请输入损伤部件分组" value="${carParts.damage_parts_group}"/>
                           </div>
						  </div>
                           <div class="form-group">
						    <label for="damage_position" class="col-sm-2 control-label">损伤部位</label><div class="col-sm-5">
						  <input type="text" class="form-control" name="damage_position" id="damage_position" placeholder="请输入损伤部位" value="${carParts.damage_position}"/>
                          </div>
						  </div>
                            <div class="form-group">
						    <label for="damage_parts" class="col-sm-2 control-label">损伤部件</label><div class="col-sm-5">
						  <input type="text" class="form-control" name="damage_parts" id="damage_parts" placeholder="请输入损伤部件" value="${carParts.damage_parts}"/></div>
						  </div>
                            <div class="form-group">
						    <label for="partsname" class="col-sm-2 control-label">配件名称</label><div class="col-sm-5">
						  <input type="text" class="form-control" name="partsname" id="partsname" placeholder="请输入配件名称" value="${carParts.partsname}"/></div>
						  </div>
                            <div class="form-group">
						    <label for="partsnumber" class="col-sm-2 control-label">配件编号</label><div class="col-sm-5">
						  <input type="text" class="form-control" name="partsnumber" id="partsnumber" placeholder="请输入配件编号" value="${carParts.partsnumber}"/></div>
						  </div>
                            <div class="form-group">
						    <label for="firmsnumber" class="col-sm-2 control-label">原厂编号</label><div class="col-sm-5">
						  <input type="text" class="form-control" name="firmsnumber" id="firmsnumber" placeholder="请输入原厂编号" value="${carParts.firmsnumber}"/></div>
						  </div>
                            <div class="form-group">
						    <label for="applymodel"class="col-sm-2 control-label">适用车型</label><div class="col-sm-5">
						  <input type="text" class="form-control" name="applymodel" id="applymodel" placeholder="请输入适用车型" value="${carParts.applymodel}"/></div>
						  </div>
                            <div class="form-group">
						    <label for="partsprice"class="col-sm-2 control-label">配件价格</label>
						  <div class="col-sm-5"><input type="text" class="form-control" name="partsprice" id="partsprice" placeholder="请输入配件价格" value="${carParts.partsprice}"/></div>
						  </div>
                            <div class="form-group">
      ...
      <c:choose>
      <c:when test="${it eq carParts.partstype}">
       <option value="${it}" selected>${it}</option>
      </c:when>
      
      <c:otherwise> <option value="${it}">${it}</option></c:otherwise>
						 ...
						 <textarea name="remarks"   id="remarks" class="form-control">${carParts.remarks}</textarea>
						</div>
                          </div>
