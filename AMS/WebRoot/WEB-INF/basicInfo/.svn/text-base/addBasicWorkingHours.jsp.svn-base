...
<html lang="zh-cn">
	<head>
		<meta charset="utf-8" />
		<title>系统管理 —数据字典-添加基础标准工时信息</title>
        ...
        <li>	    
         ...
         <li class="active">	    
			...
			<div class="col-md-10">
					<h2>基础标准工时信息添加</h2>
					<hr>
				<form id="formId" enctype="multipart/form-data" action="<%=basePath%>/workingHours/addWorkingHours" method="post" class="form-horizontal">
